...
class EstacaoController:
    ...
    estac_controller = Blueprint(name='estacao_controller', import_name=__name__)

    @estac_controller.route('/estacoes', methods=['GET'])
    def index():
    ...
    @estac_controller.route('/estacoes/<id>', methods=['GET'])
    def get_produto(id):
    ...
    @estac_controller.route('/estacoes', methods=['POST'])
    def create():
    ...
    @estac_controller.route('/estacoes/<id>', methods=['PUT'])
    def update(id):
    ...
    @estac_controller.route('/estacoes/<id>', methods=['DELETE'])
    def delete(id):
        estacao = Estacoes().query.get(id)
